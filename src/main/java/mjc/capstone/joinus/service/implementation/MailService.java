...
public class MailService {
    ...
    private MimeMessage createEmailForm(String toEmail, String title, String authCode) {
        ...
        try {
            ...
            body += "<p style='padding-top: 20px; font-size: 18px; opacity: 0.6; line-height: 30px; font-weight: 400;'>안녕하세요? MEETNY 관리자 입니다.<br />";
            body += "MEETNY 서비스 사용을 위해 회원가입시 고객님께서 입력하신 이메일 주소의 인증이 필요합니다.<br />";
            body += "하단의 인증 번호로 이메일 인증을 완료하시면, 정상적으로 MEETNY 서비스를 이용하실 수 있습니다.<br />";
            body += "항상 최선의 노력을 다하는 MEETNY가 되겠습니다.<br />";
            body += "감사합니다.</p>";
